Contributing to rBTC20 Core
============================

The rBTC20 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the rBTC20 Core project, and is not to be
confused with overall rBTC20 Network Protocol consensus changes.

Whether a pull request is merged into rBTC20 Core rests with the project merge
...
Patches that change rBTC20 consensus rules are considerably more involved than
...
Where a patchset proposes to change the rBTC20 consensus, it must have been
...
The project leader is the release manager for each rBTC20 Core release.
