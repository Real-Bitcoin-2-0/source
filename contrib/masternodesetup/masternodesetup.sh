...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='rBTC20.conf'
CONFIGFOLDER='/root/.rBTC20'
COIN_DAEMON='rBTC20d'
COIN_CLI='rBTC20-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/rBTC20/rBTC20/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
