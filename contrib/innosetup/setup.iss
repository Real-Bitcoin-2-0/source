...
#define MyAppName "rBTC20 Core"
#define MyAppPublisher "2021-2022 The rBTC20 Developers"
#define MyAppURL "https://github.com/Real-Bitcoin-2-0/rBTC20"
#define MyAppExeName "rBTC20-qt.exe"
#define MyAppExtraData "https://github.com/Real-Bitcoin-2-0/rBTC20/releases/download/v2.0/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=rBTC20Setup
...
[Files]
Source: ".\package\rBTC20-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\rBTC20\rBTC20-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\rBTC20\rBTC20-Qt,strDataDir|{userappdata}\rBTC20\}');
  Result := True;
end;
