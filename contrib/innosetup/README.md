...
* Fill in the following data:
    * Application Name: `rBTC20 Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The rBTC20 Developers`
    * Application Website: `https://realbtc20.com/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `rBTC20`
* Add application files:
    * Select the file `rBTC20-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `rBTC20-2.0.0-win64-setup.exe`
