...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected rBTC20 and zrBTC20 supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zrBTC20supply']:
                assert_equal(node['zrBTC20supply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check rBTC20 and zrBTC20 supply at the beginning
        # ------------------------------------------
        # zrBTC20 supply: 2 coins for each denomination
        ...
        # rBTC20 supply: block rewards minus burned fees for minting
        ...
        # Verify that rBTC20 and zrBTC20 supplies were properly updated after the spends and reorgs
        self.log.info("Check rBTC20 and zrBTC20 supply...")
