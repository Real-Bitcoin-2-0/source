...
"""Verify that starting rBTC20 with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rBTC20 with -? for help text")
        ...
        self.log.info("Start rBTC20 with -version for version information")
