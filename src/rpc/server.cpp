...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* rBTC20 features */
        {"rBTC20", "listmasternodes", &listmasternodes, true },
        {"rBTC20", "getmasternodecount", &getmasternodecount, true },
        {"rBTC20", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"rBTC20", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"rBTC20", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"rBTC20", "masternodecurrent", &masternodecurrent, true },
        {"rBTC20", "startmasternode", &startmasternode, true },
        {"rBTC20", "createmasternodekey", &createmasternodekey, true },
        {"rBTC20", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"rBTC20", "listmasternodeconf", &listmasternodeconf, true },
        {"rBTC20", "getmasternodestatus", &getmasternodestatus, true },
        {"rBTC20", "getmasternodewinners", &getmasternodewinners, true },
        {"rBTC20", "getmasternodescores", &getmasternodescores, true },
        {"rBTC20", "mnsync", &mnsync, true },
        {"rBTC20", "spork", &spork, true },
...
{
    return "> rBTC20-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22490/\n";
}
