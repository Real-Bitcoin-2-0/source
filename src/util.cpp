...
const char * const PIVX_CONF_FILENAME = "rBTC20.conf";
const char * const PIVX_PID_FILENAME = "rBTC20.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";
const char * const PIVX_ACTIVE_MASTERNODE_CONF_FILENAME = "activemasternode.conf";


// rBTC20 only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\rBTC20
// Windows >= Vista: C:\Users\Username\AppData\Roaming\rBTC20
// Mac: ~/Library/Application Support/rBTC20
// Unix: ~/.rBTC20
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "rBTC20";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty rBTC20.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=22490\naddnode=seed1.realbtc20.com:22489\naddnode=seed2.realbtc20.com:22489\naddnode=seed3.realbtc20.com:22489\naddnode=seed4.realbtc20.com:22489\naddnode=seed5.realbtc20.com:22489\naddnode=seed6.realbtc20.com:22489\naddnode=seed7.realbtc20.com:22489\naddnode=seed8.realbtc20.com:22489\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override rBTC20.conf
