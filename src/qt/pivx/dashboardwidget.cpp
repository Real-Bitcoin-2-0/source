    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of rBTC20 earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 rBTC20");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("rBTC20")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair rBTC20
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(23,185,198));
	set1->setColor(QColor(41,102,116));
