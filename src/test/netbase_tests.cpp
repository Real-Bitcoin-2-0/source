...
BOOST_AUTO_TEST_CASE(netbase_networks)
{
    ...
    BOOST_CHECK(ResolveIP("2001::22490").GetNetwork()                             == NET_IPV6);
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:22489", "127.0.0.1", 22489));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:22489", "127.0.0.1", 22489));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:22489", "::ffff:127.0.0.1", 22489));
    BOOST_CHECK(TestSplitHost("[::]:22489", "::", 22489));
    BOOST_CHECK(TestSplitHost("::22489", "::22489", -1));
    BOOST_CHECK(TestSplitHost(":22489", "", 22489));
    BOOST_CHECK(TestSplitHost("[]:22489", "", 22489));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:22489", "127.0.0.1:22489"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:22489", "[::]:22489"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
BOOST_AUTO_TEST_CASE(validate_test)
{
    ...
    std::list<std::string> validIPv6 = {"1111:2222:3333:4444:5555:6666::22490", "2001:0002:6c::430", "2002:cb0a:3cdd:1::1"};
    ...
    std::list<std::string> invalidIPv6 = {"1111:2222:3333:4444:5555:6666:7777:22490:9999", "2002:cb0a:3cdd::1::1", "1111:2222:3333:::5555:6666:7777:22490"};
