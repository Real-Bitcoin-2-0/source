...
// Copyright (c) 2021-2023 The rBTC20 Developers
...
{
	if(nHeight >  69300000) return      0.000000000 * COIN;
	if(nHeight >  67200000) return      0.000000001 * COIN;
	if(nHeight >  65100000) return      0.000000002 * COIN;
	if(nHeight >  63000000) return      0.000000005 * COIN;
	if(nHeight >  60900000) return      0.000000009 * COIN;
	if(nHeight >  58800000) return      0.000000019 * COIN;
	if(nHeight >  56700000) return      0.000000037 * COIN;
	if(nHeight >  54600000) return      0.000000075 * COIN;
	if(nHeight >  52500000) return      0.000000149 * COIN;
	if(nHeight >  50400000) return      0.000000298 * COIN;
	if(nHeight >  48300000) return      0.000000596 * COIN;
	if(nHeight >  46200000) return      0.000001192 * COIN;
	if(nHeight >  44100000) return      0.000002384 * COIN;
    if(nHeight >  42000000) return      0.000004768 * COIN;
    if(nHeight >  39900000) return      0.000009537 * COIN;
    if(nHeight >  37800000) return      0.000019073 * COIN;
    if(nHeight >  35700000) return      0.000038147 * COIN;
    if(nHeight >  33600000) return      0.000076294 * COIN;
    if(nHeight >  31500000) return      0.000152588 * COIN;
	if(nHeight >  29400000) return      0.000305176 * COIN;
    if(nHeight >  27300000) return      0.000610352 * COIN;
    if(nHeight >  25200000) return      0.001220703 * COIN;
	if(nHeight >  23100000) return      0.002441406 * COIN;
    if(nHeight >  21000000) return      0.004882813 * COIN;
    if(nHeight >  18900000) return      0.009765625 * COIN;
    if(nHeight >  16800000) return      0.01953125 * COIN;
    if(nHeight >  14700000) return      0.0390625 * COIN;
    if(nHeight >  12600000) return      0.078125 * COIN;
    if(nHeight >  10500000) return      0.15625 * COIN;
    if(nHeight >   8400000) return      0.3125 * COIN;
    if(nHeight >   6300000) return      0.625 * COIN;
    if(nHeight >   4200000) return      1.25 * COIN;
    if(nHeight >   2100000) return      2.5 * COIN;
...
{
    if(nHeight >   500) return GetBlockValue(nHeight) * 10 / 100;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 rBTC20 tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 rBTC20 tx -> 1 confirmation
