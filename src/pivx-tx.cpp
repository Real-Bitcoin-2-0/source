...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("rBTC20 rBTC20-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rBTC20-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rBTC20 transaction") + "\n" +
                               "  rBTC20-tx [options] -create [commands]   " + _("Create hex-encoded rBTC20 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rBTC20 transaction
